...
namespace WindowsFormsApp1
{
    public partial class ProjectList : Form
    {
        ...
        {
            IsScheduledSelected(projectListGrid);
        }   //InProgressre állítás

        private void button3_Click(object sender, EventArgs e)  //Sikeres projekt
        {
            CompletedProject(projectListGrid);
        }

        private void button4_Click(object sender, EventArgs e)  //Sikertelen projekt
        {
            FailedProject(projectListGrid);
        }
    }
}
